...
-- Performance 1
insert into Performance ( show_id, date) values ( 1, '2014-01-29 19:00:00');

-- Performance 2
insert into Performance ( show_id, date) values ( 1, '2014-01-30 19:00:00');

-- Show 2
insert into Show ( event_id, venue_id) values ( 1, 2);

-- Performance 3
insert into Performance ( show_id, date) values ( 2, '2014-01-31 19:30:00');

-- Performance #4
insert into Performance ( show_id, date) values ( 2, '2014-02-01 19:30:00');
...
-- Performance 5
insert into Performance ( show_id, date) values ( 3, '2014-02-02 17:00:00');


-- Performance 6
insert into Performance ( show_id, date) values ( 3, '2014-02-02 19:30:00');

-- Show 4
insert into Show ( event_id, venue_id) values ( 2, 2);

-- Performance 7
insert into Performance ( show_id, date) values ( 4, '2014-02-04 17:00:00');


-- Performance 8
insert into Performance ( show_id, date) values ( 4, '2014-02-04 19:30:00');
...
-- Performance 9
insert into Performance ( show_id, date) values ( 5, '2014-03-11 21:00:00');

-- Show 6
insert into Show ( event_id, venue_id) values ( 1, 5);

-- Performance 10
insert into Performance ( show_id, date) values ( 6, '2014-01-29 19:00:00');


-- Performance 11
insert into Performance ( show_id, date) values ( 6, '2014-01-30 19:00:00');
