 ...
 * 
 * <p>
 * A show contains a set of performances, and a set of ticket prices for each
 * section of the venue for this show.
 * </p>
 * 
 * <p>
...
public class Show implements Serializable {
	 ...
	 * set of performances, so, for example if a show is removed, then all of
	 * it's performances will also be removed.
	 * </p>
	 * 
	 * <p>
	 ...
	 * attribute establishes this. We cascade all persistence operations to the
	 * set of performances, so, for example if a show is removed, then all of
	 * it's ticket price categories are also removed.
	 * </p>
	 */
	@OneToMany(mappedBy = "show", cascade = ALL, fetch = EAGER)
	//@Field(name = "ticketPrices.min", analyze = Analyze.NO, bridge = @FieldBridge(impl = PriceMinBridge.class))
